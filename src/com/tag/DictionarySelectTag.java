...
public class DictionarySelectTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		// 如果ids或typeId或typeName不都为空，则获得数据。优先级为：ids>typeId>typeName, �?般只�?指定其中�?�?
	...
	private String headerKey;	// 请�?�择的�??
	private String headerValue = "--请�?�择--";

	private String itemName; 	// 字典类型名称
	private String itemIds; 	// 字典选项�?
	private String value; 		// 选中�?
