	...
	<div class="row">
		...
		<form id="form-search" class="form-inline" method="post">
  			<div class="form-group">
		    	生产商姓名 <input type="text" style="width:120px;" class="form-control" name="Q_LKS_name">
		  	</div>
		  	<div class="form-group">
		    	类别 <k:dictSelect name="Q_EQI_sex.id" className="form-control" itemName="性别" headerKey=""/>
		  	</div>
		  	<div class="form-group">
		    	部门<input type="text" style="width:120px;" class="form-control" name="Q_LKS_dept.dname">
		  	</div>
		  	<div class="form-group">
		    	地址 <k:dictSelect name="Q_EQI_job.id" className="form-control" itemName="职位" headerKey=""/>
		  	</div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		grid.jqGrid({
			...
			url: 'emp/list',
			caption: '<i class="glyphicon glyphicon-list"></i>生产商信息管理',
			colModel: [
				...
				{label: '生产商姓名', name: 'name', width: 30, editable: true},
				{label: '所属部门', name: 'dept.dname', width: 50},
				{label: '职位', name: 'job.itemValue', width: 50},
				{label: '类别', name: 'sex.itemValue', width:30},
				{label: '成立时间', name: 'age', width: 30},
