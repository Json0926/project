...
<script type="text/javascript">
	 ...
	 */
	 ...
	 $(function() {
		...
		grid.jqGrid({
			url: 'emp/listCoach',
			caption: '<span class="glyphicon glyphicon-list"></span> 信息反馈列表',
			colModel: [
				{label: 'ID', name: 'id', hidden: true},
				{label: '姓名', name: 'name', width: 100},
				{label: '性别', name: 'sex.itemValue', width: 100},
				{label: '内容', name: 'job.itemValue', width: 100},
		...
		// detail-grid
		detailGrid.jqGrid({			
			caption: '<span class="glyphicon glyphicon-list"></span> 所属环节',
			colModel: [
				{label: 'ID', name: 'id', hidden: true},
				{label: '姓名', name: 'name', width: 100},
				{label: '性别', name: 'sex.itemValue', width: 100},
				{label: '问题所属', name: 'age', width: 100},
