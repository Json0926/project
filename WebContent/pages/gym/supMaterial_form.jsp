...
<tr>
								...
								<tr>
									<td width="90">供应时间</td>
									<td><input class="form-control" name="supplierDate" type="date" value="${material.supplierDate }"></td>
								</tr>
								<tr style="display:none">
									<td width="90">供应商企业ID</td>
									<!-- <td><input class="form-control" name="supplierId" type="text" value="${material.supplyId }"></td> -->
									<td>
								...
								<tr>
									...
									<select class="form-control" name="supplierName">
										<%-- <c:forEach var="gysqymc" items="${gysqymc}"> --%>
										<option>天津一汽丰田发动机有限公司</option>
										<%-- </c:forEach> --%>
									</select>	
									<input type="hidden" class="form-control" name="supplierName" type="text" value="${material.supplierName }"></td>
								</tr>
								<tr>
									<td width="90">生产商企业名</td>
									<td>
									<select class="form-control" name="manufactureName">
										<c:forEach var="manuName" items="${manuName}">
										<option>${manuName}</option>
										</c:forEach>
									</select>
									</td>
									<input type="hidden" class="form-control" name="manufactureName" type="text" value="${material.manufactureName }"></td>
								</tr>
